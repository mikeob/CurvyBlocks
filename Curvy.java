...
public class Curvy
{
    ...
    public static void main(String[] args)
    {
        ...
        while (in.hasNextLine())
        {
            ...
            double d1 =
                 5000 + Double.parseDouble(top[0]);
            double d2 =
                -1 * Double.parseDouble(bottom[1]) + Double.parseDouble(top[1]);
            double d3 =
                -1 * Double.parseDouble(bottom[2]) + Double.parseDouble(top[2]);
            double d4 =
                -1 * Double.parseDouble(bottom[3]) + Double.parseDouble(top[3]);
